  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      await fetch("/api/public/contact", {
        ...
        body: JSON.stringify({ fullName: name, email, subject: topic, message }),
      });
    ...
    <main>
        ...
        <div className="hero-content page-width">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <a className="button button-primary" href="#services">{t.heroCtaSecondary} <ChevronRight size={17} /></a>
            </div>
      ...
      <section className="app-preview-section page-section" id="fonctionnalites">
        <div className="page-width preview-grid">
          <div className="preview-copy"><SectionIntro eyebrow={t.previewEyebrow} title={t.previewTitle} text={t.previewLead} /><div className="check-list"><div><Check size={16} /> {t.previewCheck1}</div><div><Check size={16} /> {t.previewCheck2}</div><div><Check size={16} /> {t.previewCheck3}</div></div></div>
